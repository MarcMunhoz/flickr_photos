# netlify-flickr-proxy Specification

## Purpose
Define the production Flickr proxy behavior, security controls, Netlify routing/configuration, and validation expectations for replacing the Render-hosted middleware.
